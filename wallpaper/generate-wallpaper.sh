...
#################################
#EXECUTE FROM AQUARIOS ROOT DIRECTORY
#################################
...
BASE_WALLPAPER=$(echo "$PWD"/vendor/AQUARIOS/wallpaper/"$BASE_NAME")

#OUTPUT WALLPAPERS LOCATION
OUTPUT_PACKAGE=$(echo "$PWD"/vendor/AQUARIOS/overlay/common/frameworks/base/core/res/res/)
