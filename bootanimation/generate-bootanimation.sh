...
tar xfp "$PWD/vendor/aquarios/bootanimation/bootanimation.tar" -C "$OUT/bootanimation/"
...
cat "$PWD/vendor/aquarios/bootanimation/desc.txt" >> "$ANDROID_PRODUCT_OUT/obj/BOOTANIMATION/bootanimation/desc.txt"
