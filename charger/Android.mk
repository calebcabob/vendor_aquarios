...
include $(CLEAR_VARS)
LOCAL_SRC_FILES := healthd_board_aquarios.cpp
LOCAL_MODULE := libhealthd.aquarios
LOCAL_CFLAGS := -Werror
LOCAL_C_INCLUDES := \
...
include $$(CLEAR_VARS)
LOCAL_MODULE := vendor_aquarios_charger_$(notdir $(1))
...
include $(CLEAR_VARS)
LOCAL_MODULE := aquarios_charger_res_images
LOCAL_MODULE_TAGS := optional
